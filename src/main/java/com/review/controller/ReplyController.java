...
import com.review.service.QnaReplyService;

@RestController
@RequestMapping("/repls")
public class ReplyController {
  ...
  public ResponseEntity<List<QnaReplyVO>> list(@PathVariable("no") Integer no) {
  ...
  public ResponseEntity<String> update(@PathVariable("rno") Integer rno, @RequestBody QnaReplyVO vo) {
  ...
  public ResponseEntity<Map<String, Object>> listPage(
    ...
    try {
      ...
      List<QnaReplyVO> list = service.listReplyPage(no, cri);
