...
<%@include file="../include/adminQnaHeader.jsp"%>
		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				...
				<form role="form" action="modifyPage" method="post">
					...
					<input type='hidden' name='no' value="${qnaBoardVO.no}"> <input
				...
				<div class="box-body">
					<div class="form-group">
						<label for="exampleInputEmail1">제목</label> <input type="text"
							name='title' class="form-control" value="${qnaBoardVO.title}"
							readonly="readonly">
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">내용</label>
						<textarea class="form-control" name="content" rows="5" cols="50"
							readonly="readonly">${qnaBoardVO.content}</textarea>
					</div>
					<div class="form-group">
						<label for="exampleInputEmail1">작성자</label> <input type="text"
							name="writer" class="form-control" value="${qnaBoardVO.writer}"
							readonly="readonly">
					</div>
				</div>
				<!-- /.box-body -->
   ...
   <i class="fa fa-list"></i> 목록</button>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-success">
				<div class="box-header">
					<h3 class="box-title">
					<i class="fa-fa pencil"></i>댓글 쓰기</h3>
				</div>
				<div class="box-body">
				<p>
		...
		<li class="time-label" id="repliesDiv">
		  <span class="bg-green">
		    댓글 목록 <small id='replycntSmall'> [ ${qnaBoardVO.replycnt} ] </small>
		    </span>
		  </li>
		</ul>
...
<script>
	...
	var no = ${qnaBoardVO.no};
	
	var replyPage = 1;
	
	getPage("/qreplies/" + no + "/1");
...
$(document).ready(function(){
	...
	$("#modifyBtn").on("click", function(){
		formObj.attr("action", "/admin/modifyPage");
...
/* 	$("#removeBtn").on("click", function(){
	...
	$("#removeBtn").on("click", function(){
		...
		formObj.attr("action", "/admin/removePage");
		formObj.submit();
	});	
	...
	$.getJSON("/admin/getfile/"+no,function(list){
		$(list).each(function(){
